import './style.css'
import { createIcons, Calendar, Users, Clock, ClipboardList, MapPin, Receipt, MessageSquare, BarChart, Truck, Wrench } from 'lucide'
...
// Add custom styles for the stealth page
