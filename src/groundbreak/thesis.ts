...
const html = `
  <main class="gb-page">
    ...
    <article class="gb-thesis">
      <div class="gb-thesis-kicker">A preview of the talk, about 6 minutes</div>
      ...
      <div class="gb-thesis-body">
        <p>
          ...
          Member of Technical Staff at Anthropic. She cannot tell him what
          she is working on. She can tell him where the puck is
        ...
        <p>
          ...
          frontier labs, the teams shipping agents into production, and the
          investors underwriting the next decade of software have
          aligned on a handful of claims most industries have not even read
          yet.
        </p>
        <p>
        ...
        <p>
          ...
          fragmentation, thin margins, and the rightful conservatism of anyone
        ...
        <p>
          ...
          displacement anxiety and a marketing veneer.
          Both are distractions. The actual question for owners, GCs, and
          specialty contractors is closer to this: what changes when every
        ...
        <div class="gb-thesis-proof">
          ...
          <div class="gb-thesis-proof-caption">
            I have made an earlier version of this argument on a Groundbreak stage.
        ...
        <div class="gb-thesis-takeaways">
          ...
          <ol>
            ${TALK.takeaways.map(t => `<li>${t.text}</li>`).join('')}
          </ol>
        </div>

        <p style="margin-top:2rem;">
          This talk is designed for the exact room Groundbreak assembles: the
          three buyer roles sitting next to Procore's
          product organization, with enough signal in the audience to ask hard
          questions back. The goal is not inspiration. The goal is that a
